...
def _pipeline(ticker: str, benchmark: str, past_years: int, future_years: int, freq: str) -> None:
    ...
    data, prices, benchmark_prices = preprocessing.preprocess(ticker, benchmark, past_years, freq)

    logger.info("Start of modelling.")
    data_and_pred, returns = modelling.modelling(data, prices, benchmark_prices, future_years, freq)
